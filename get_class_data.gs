...
function getClassData() {
	...
	for (var i = 0; i <= titleList.length; i++) {
		if (titleList[i] == null || titleList[i] == "") {
			continue;
		}
		var zoomLink = "";
